  ...
  (:method ((prev-state instans-trace-join-node-state) (new-state instans-trace-join-node-state))
    (let ((prev-alpha (instans-trace-join-node-state-alpha-items prev-state))
      ...
      (make-instance 'instans-trace-join-node-delta
		     :added-alpha-items (instans::list-difference prev-alpha new-alpha :test #'equal)
		     :removed-alpha-items (instans::list-difference new-alpha prev-alpha :test #'equal)
		     :added-beta-items (instans::list-difference prev-beta new-beta :test #'equal)
		     :removed-beta-items (instans::list-difference new-beta prev-beta :test #'equal))))
