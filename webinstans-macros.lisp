...
(defmacro trace-wrap-call (&key node function parameters state-form)
  (let ((node-var (gensym "NODE"))
    ...
    `(let ((,node-var ,node)
	 ...
	 (instans-trace-add-enter *instans-trace* :node ,node-var :function ,function-var :parameters ,parameters-var ,@(if state-form `(:state ,state-var))))
	 ...
	 (when *instans-trace*
	   ...
	   (instans-trace-add-exit *instans-trace* :node ,node-var :function ,function-var :parameters ,parameters-var ,@(if state-form `(:state ,state-var))))))))
